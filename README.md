...
## [Settings](https://github.com/SP-l33t/xKuCoin-Telethon/blob/master/.env-example/)
...
## Installation
You can download the [**repository**](https://github.com/SP-l33t/xKuCoin-Telethon) by cloning it to your system and installing the necessary dependencies:
```shell
